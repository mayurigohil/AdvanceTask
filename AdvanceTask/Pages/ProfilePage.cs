...
namespace AdvanceTask.Pages
{
    class ProfilePage
    {
        ...
        public void AddDesCriptionDetails(IWebDriver driver)
        {
            ...
            Tests._test.Log(Status.Info, "Clicked on Save");
        }
        ...
        public void ValidateAddDesCriptionDetails(IWebDriver driver)
        {
            try
            {
                ...
                Tests._test.Log(Status.Pass, "Description has been saved successfully");
            }
            catch
            {
                Assert.Fail("Description not added");
                Tests._test.Log(Status.Fail, "Description not added");
            }
        ...
        public void AddLanguageDetails(IWebDriver driver)
        {
            ...
            Add.Click();
            Tests._test.Log(Status.Info, "Clicked on Add");
        }
        ...
        public void ValidateAddLanguageDetails(IWebDriver driver)
        {
            try
            {
                ...
                Tests._test.Log(Status.Pass, "Language has been added successfully");
            }
            catch
            {
                ...
                {
                    Tests._test.Log(Status.Fail, "Error Message :" + NotificationText);
                    Tests._test.Log(Status.Fail, "Snapshot below: " + CommonDriver.SaveScreenshot(driver, "Share Skill Failed"));
                }
            }
        }
        ...
        public void EditLanguageDetails(IWebDriver driver)
        {
            ...
            Level.SelectByValue(ExcelLibHelper.ReadData(rownum, "Level"));
            Update.Click();
            Tests._test.Log(Status.Info, "Clicked on Update");
        }
        public void ValidateEditLanguageDetails(IWebDriver driver)
        {
            try
            {
                ...
                Tests._test.Log(Status.Pass, "Language has been Updated successfully");
            }
            catch
            {
                var NotificationText = Notification.Text;
                ...
                {
                    Tests._test.Log(Status.Fail, "Error Message :" + NotificationText);
                    Tests._test.Log(Status.Fail, "Snapshot below: " + CommonDriver.SaveScreenshot(driver, "Language has not been added"));
                }
            }
        }
        public void DeleteLanguageDetails(IWebDriver driver)
        {
            ...
            Tests._test.Log(Status.Info, "Clicked on Delete");
            WaitClass.ElementPresent(driver, "ClassName", "ns-box-inner");
            TestContext.WriteLine(Language);
            Assert.That(Notification.Text == Language + " " + "has been deleted from your languages");
            Tests._test.Log(Status.Pass, "Language has been deleted successfully");
        }
        ...
        public void ValidateAddSkillDetails(IWebDriver driver)
        {
            try
            {
                ...
                Tests._test.Log(Status.Pass, "Skills has been added successfully");
            }
            catch
            {
                var NotificationText = Notification.Text;
        ...
        public void ValidateEditSkillDetails(IWebDriver driver)
        {
            try
            {
                ...
                Tests._test.Log(Status.Pass, "SKills has been Updated successfully");
            }
            catch
            {
                var NotificationText = Notification.Text;
                ...
                {
                    Tests._test.Log(Status.Fail, "Error Message :" + NotificationText);
                    Tests._test.Log(Status.Fail, "Snapshot below: " + CommonDriver.SaveScreenshot(driver, "Skills has not been updated"));
                }
            }
        }
        public void DeleteSkillDetails(IWebDriver driver)
        {
            try
            {
                ...
                Tests._test.Log(Status.Pass, "Skills are deleted successfully");
            }
            catch
            {
                var NotificationText = Notification.Text;
                ...
                {
                    Tests._test.Log(Status.Fail, "Error Message :" + NotificationText);
                    Tests._test.Log(Status.Fail, "Snapshot below: " + CommonDriver.SaveScreenshot(driver, "Delete Skill Failed"));
                }
            }
        ...
        public void ValidateEducationDetails(IWebDriver driver)
        {
            try
            {
                ...
                Tests._test.Log(Status.Info, NotificationText);
                Tests._test.Log(Status.Pass, "Education has been added successfully");
            }
            catch
            {
                var NotificationText = Notification.Text;
        ...
        public void ValidateEditEducation(IWebDriver driver)
        {
            try
            {
                ...
                Tests._test.Log(Status.Pass, "Education has been Edited successfully");
            }
            catch
            {
                var NotificationText = Notification.Text;
        ...
        public void ValidateDeleteEducation(IWebDriver driver)
        {
            try
            {
                ...
                Tests._test.Log(Status.Pass, "Description has been deleted successfully");
            }
        ...
        public void ValidateCertificationDetails(IWebDriver driver)
        {
            ...
            Assert.That(Notification.Text == Certifcate + " " + "has been added to your certification");
                Tests._test.Log(Status.Pass, "Certificate has been added successfully");
            }
            catch
            {
                var NotificationText = Notification.Text;
        ...
        public void EditCertificateDetails(IWebDriver driver)
        {
            ...
            Tests._test.Log(Status.Info, "Certification is updated");
        }
        ...
        public void ValidateEditCertificate(IWebDriver driver)
        {
            try
            {
                ...
                Tests._test.Log(Status.Pass, "Certification is updated" +
                    " successfully");
            }
        ...
        public void ValidateDeleteCertificate(IWebDriver driver)
        {
            try
            {
                ...
                Tests._test.Log(Status.Pass, "Certificate has been deleted successfully");
            }
            catch
            {
                var NotificationText = Notification.Text;
        ...
        public void FinalValidation(IWebDriver driver)
        {
            ...
            //if (status == TestStatus.Failed)
            //{
            //   Tests._test.Log(Status.Fail, errorMessage + ProfilePage.NotificationText);
            //    Tests._test.Log(Status.Fail, "Snapshot below: " + CommonDriver.SaveScreenshot(driver, "Share Skill Failed"));
            //}
        }
    }
